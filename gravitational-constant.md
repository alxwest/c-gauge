...
\subsection{Gravitational constant}\label{gravitational-constant}
...
the 1\textsuperscript{st} degree mass function with one neat trick. With
...
define a 1\textsuperscript{st} degree mass function to define the
2\textsuperscript{nd} degree mass function:
...
2\textsuperscript{nd} degree mass function requires a donor system:
...
We use \(d_{2}\) as the 2\textsuperscript{nd} degree mass function will 
...
we did with the 1\textsuperscript{st} degree mass function:
...
\subsubsection{Mean at scale}\label{mean-at-scale}
...
can assume G will vary due to the shape and composition of matter.
...
\begin{figure}
  \centering
  \includesvg[width=400pt]{chart2}
  \caption{Analogue vs. binary}
  \label{fig:chart2}
\end{figure}
...
20\textsuperscript{th} century, where Hasenöhrl \cite[p.~1039]{kaiserl1904sitzungsberichte} 
...
2\textsuperscript{nd} degree mass function, and other functions
...
\subsubsection{Mean 2D function}\label{mean-2d-function}
...
\subsubsection{Mean 3D function}\label{mean-3d-function}
...
\subsubsection{Calculated mean gravitational
constant}\label{calculated-mean-gravitational-constant}
...
\section{Comparison with measured constant}\label{comparison-with-measured-constant}
...
\begin{figure}
  \centering
  \includesvg{chart}
  \caption{measurement of G post 2000}
  \label{fig:chart}
\end{figure}
